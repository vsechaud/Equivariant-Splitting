...
* Equivariant splitting is now [natively supported in DeepInverse!](https://deepinv.github.io/deepinv/auto_examples/self-supervised-learning/demo_equivariant_splitting.html)
